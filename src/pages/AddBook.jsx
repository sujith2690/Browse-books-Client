...
//                 onBlur={handleBlur}
//                 name="category"
//                 id="category" className="w-full p-2 outline-none rounded-md  focus:ring focus:ring-indigo-500 border-gray-700 text-gray-900 capitalize">
...
//                 <p className="text-red-600 text-center text-sm">{errors.category}</p>
//               ) : null}
//             </div>
//             <div className="col-span-full sm:col-span-3">
